...
assembler.recipeBuilder()
	.inputs([machineCasingMv, dynamoHatchMv, circuitBoardPlastic, <ore:plateAluminium> *2, <ore:cableGtSingleCopper> *2, <ore:circuitExtreme> *2])
    .fluidInputs([<liquid:plastic> *72])
...
assembler.recipeBuilder()
	.inputs([machineCasingMv, <ore:paneGlass>, <ore:circuitGood> *2, computerMonitor *2])
    .fluidInputs([<liquid:plastic> *72])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 1}))
...
assembler.recipeBuilder()
	.inputs([machineCasingMv, <opencomputers:screen2>, <ore:circuitExtreme> *2, computerMonitor])
    .fluidInputs([<liquid:plastic> *72])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 1}))
...
assembler.recipeBuilder()
	.inputs([machineCasingMv, <opencomputers:screen1>, <ore:circuitAdvanced> *2, computerMonitor])
    .fluidInputs([<liquid:plastic> *72])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 1}))
...
circuit_assembler.recipeBuilder()
	.inputs([NAND *2, <ore:circuitAdvanced>])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 1}))
	.outputs(controlUnit)
...
assembler.recipeBuilder()
	.inputs([circuitBoardPlastic, microchipMv, <ore:pipeTinyPlastic> *8, <ore:boltElectrum> *8])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 1}))
...
assembler.recipeBuilder()
	.inputs([circuitBoardPlastic, <ore:circuitGood>, integratedCircuit *2, <ore:foilElectrum> *4])
...
assembler.recipeBuilder()
	.inputs([circuitBoardAdvanced, <ore:circuitAdvanced>, <ore:componentTransistor> *2, <ore:foilElectrum> *8])
    .fluidInputs([<liquid:soldering_alloy> *72])
...
assembler.recipeBuilder()
	.inputs([circuitBoardExtreme, <ore:circuitExtreme>, <ore:componentTransistor> *8, <ore:foilElectrum> *16])
    .fluidInputs([<liquid:soldering_alloy> *72])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 2}))
	.outputs(microchipEv)
	.duration(300).EUt(480).buildAndRegister();
...
assembler.recipeBuilder()
	.inputs([circuitBoardPlastic, <ore:plateAluminium>, <opencomputers:capacitor>, <ore:batteryGood> *2, <ore:wireFineRedAlloy> *8])
    .fluidInputs([<liquid:soldering_alloy> *144])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 1}))
...
assembler.recipeBuilder()
	.inputs([circuitBoardAdvanced, <ore:plateTitanium>, <opencomputers:capacitor> *2, <ore:batteryAdvanced> *2, <ore:wireFineRedAlloy> *8])
    .fluidInputs([<liquid:soldering_alloy> *144])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 1}))
...
assembler.recipeBuilder()
	.inputs([circuitBoardExtreme, <ore:plateTungstenSteel>, <opencomputers:capacitor> *4, <ore:batteryExtreme> *2, <ore:wireFineRedAlloy> *8])
    .fluidInputs([<liquid:soldering_alloy> *144])
	.notConsumable(<metaitem:circuit.integrated>.withTag({Configuration: 1}))
